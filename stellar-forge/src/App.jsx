      ...
      <group ref={mesh} onClick={handleClick} onPointerOver={() => setHover(true)} onPointerOut={() => setHover(false)}>
        ...
        <mesh castShadow receiveShadow>
          ...
          <meshStandardMaterial
            map={textureMap}
            color={exploded ? "#111" : hovered ? "#aaf" : "white"}
            roughness={0.8}
          />
        </mesh>
...
const UIStyles = () => (
  <style>{`
    ...
    /* Improved mobile responsive styles for better phone UI */
    ...
    >
      ...
      >
        ...
        <div className="hud-panel top-left" style={{ position: "absolute", top: 30, left: 30, width: 280 }}>
          ...
          <div className="desc-text" style={{ borderTop: "1px solid rgba(255,255,255,0.1)" }}>
        ...
        <div
          ...
          style={{
            ...
            right: 30,
            textAlign: "right",
            opacity: selectedPlanet ? 0 : 0.6,
            transition: "opacity 0.5s",
          }}
        >
          <div className="title-small" style={{ color: "white" }}>
            INSTRUCTIONS
          </div>
          ...
          <div className="hud-panel controls-inner">
            <div className="control-group">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                <input
                  ...
                  disabled={isPlaying}
                />
                <span style={{ fontFamily: "Orbitron", width: "30px", flexShrink: 0 }}>{mass}</span>
              </div>
            </div>
            ...
            <div className="control-group">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                />
                <span style={{ fontFamily: "Orbitron", width: "35px", flexShrink: 0 }}>{age.toFixed(1)}</span>
              </div>
            </div>

            <div
              className="control-divider"
              style={{ height: "30px", width: "1px", background: "rgba(255,255,255,0.2)" }}
            ></div>

            <div className="btn-controls-row" style={{ display: "flex", gap: "10px", alignItems: "center" }}>
              <button
      ...
      <Canvas shadows camera={{ position: [0, 25, 40], fov: 45 }} onPointerMissed={handleBackgroundClick}>
        ...
        <CameraShake
          maxYaw={exploded ? 0.1 : 0}
          maxPitch={exploded ? 0.1 : 0}
          maxRoll={exploded ? 0.1 : 0}
          yawFrequency={exploded ? 10 : 0}
          intensity={1}
          decayRate={0.65}
        />
        <EffectComposer>
